...
**A local-workspace coding assistant for Windows.**
...
> [!NOTE]
> On first run, SmartScreen may warn (no code-signing cert yet) → **More info → Run anyway**.

---

This repository is the **release + auto-update feed only** — no source, no issues. The source is private; this is just where the signed builds live.

<sub>© 2026 Braison Swilling. Proprietary — all rights reserved. See [LICENSE](LICENSE).</sub>
